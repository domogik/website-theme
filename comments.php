...
<h2><?php __('Protected by password', $MY_TEXTDOMAIN); ?></h2>
<p><?php __('Enter the password to see the comments', $MY_TEXTDOMAIN); ?></p>
...
<?php if ($comments) : ?>
	<h3 id="comments"><?php comments_number('No comment', 'One comment', '% comments' );?> pour &#8220;<?php the_title(); ?>&#8221;</h3>
...
<strong><?php comment_author_link() ?></strong>, <?php _e('le'); ?> <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('j F, Y') ?> <?php _e('&agrave;');?> <?php comment_time() ?></a> <?php _e('Said&#58;'); ?> <?php edit_comment_link('Edit Comment','',''); ?>
		...
		<em><?php __('Your comment is awaiting moderation', $MY_TEXTDOMAIN); ?></em>
 		<?php endif; ?>
</div>
...
<!--<p><small><strong>XHTML:</strong> <?php __('You can use these tags', $MY_TEXTDOMAIN); ?> <?php echo allowed_tags(); ?></small></p>-->
