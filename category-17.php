...
<div id='content' role='main'>
    <div id='post'>
        <?php query_posts( 'showposts=10&cat=17&order=DESC&orderby=date' );
        if (have_posts()) :
        while (have_posts()) : the_post(); ?>
        <h2><a href="<?php the_permalink() ?>" rel="bookmark" title="Link to <?php the_title_attribute(); ?>"><?php the_title(); ?>
        </a>
        </h2>
